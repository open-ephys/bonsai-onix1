...
namespace OpenEphys.Onix1
{
    class NeuropixelsV2RegisterContext : I2CRegisterContext
    {
        ...
        public NeuropixelsV2RegisterContext(I2CRegisterContext other, uint i2cAddress, ValidationStrictness strictness)
            : base(other, i2cAddress)
        {
            this.strictness = strictness;
        }

        public NeuropixelsV2RegisterContext(DeviceContext deviceContext, uint i2cAddress, ValidationStrictness strictness)
