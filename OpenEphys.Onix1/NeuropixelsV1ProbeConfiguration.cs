...
namespace OpenEphys.Onix1
{
    ...
    public class NeuropixelsV1ProbeConfiguration : IProbeInterfaceConfiguration
    {
        ...
        /// <remarks>
        /// <para>
        /// Each probe is linked to a gain calibration file that contains gain adjustments determined by IMEC
        /// during factory testing. Electrode voltages are scaled using these values to ensure they can be
        /// accurately compared across probes. Therefore, using the correct gain calibration file is mandatory
        /// to create standardized recordings.
        /// </para>
        /// <para>
        /// Calibration files are probe-specific and not interchangeable across probes. Calibration files must
        /// contain the serial number of the corresponding probe on their first line of text. If you have lost
        /// track of a calibration file for your probe, email IMEC at neuropixels.info@imec.be with the probe
        /// serial number to retrieve a new copy.
        /// </para>
        /// <para>
        ...
        /// <remarks>
        /// <para>
        /// Each probe must be provided with an ADC calibration file that contains probe-specific hardware
        /// settings that is created by IMEC during factory calibration. These files are used to set internal
        /// bias currents, correct for ADC nonlinearities, correct ADC-zero crossing non-monotonicities, etc.
        /// Using the correct calibration file is mandatory for the probe to operate correctly. 
        /// </para>
        /// <para>
        /// Calibration files are probe-specific and not interchangeable across probes. Calibration files must
        /// contain the serial number of the corresponding probe on their first line of text. If you have lost
        ...
        /// <remarks>
        /// <para>
        /// Neuropixels contain inverting amplifiers. This means that neural data that is captured by the
        /// probe will be inverted compared to the physical signal that occurs at the electrode: e.g.,
        /// extracellular action potentials will tend to have positive deflections instead of negative.
