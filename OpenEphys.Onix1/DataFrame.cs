namespace OpenEphys.Onix1
{
    ...
    public abstract class DataFrame
    {
        ...
        /// The acquisition clock rate is given by <see cref="OnixContextTask.AcquisitionClockHz"/>. This clock value provides a common, synchronized
        ...
        /// for controlling devices and arbitrating data stream that runs asynchronously from the <see cref="OnixContextTask.AcquisitionClockHz"/>. This value
