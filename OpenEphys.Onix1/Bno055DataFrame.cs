...
namespace OpenEphys.Onix1
{
    ...
    /// cref="Bno055DataFrame"/> depends on the sensor fusion mode that is enable and the axis configuration
    /// (see page. 26 of the <a
    ...
    /// magnetic field. Specifically, if the chip's axes are oriented such that Y points magnetic north, X
    /// points magnetic east, and Z points opposite the gravity vector, the orientation reading will be null
    /// (i.e. Quaternion: X = 0, Y = 0, Z = 0, W = 1; Euler Angles: Yaw = 0, Pitch = 0, and Roll = 0 degrees;
    /// Gravity: X = 0, Y = 0, Z = 9.8 m/s^2). Linear acceleration readings are always taken relative to the
    /// chip's axis definitions (they are "egocentric").
    /// </remarks>
