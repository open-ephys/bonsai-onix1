...
namespace OpenEphys.Onix1
{
    ...
    public class NeuropixelsV2ProbeConfiguration
    {
        ...
        public NeuropixelsV2ProbeConfiguration(NeuropixelsV2ProbeConfiguration probeConfiguration)
        {
            ...
            ProbeGroup = new(probeConfiguration.ProbeGroup);
            ChannelMap = NeuropixelsV2eProbeGroup.ToChannelMap(ProbeGroup, ProbeType);
        ...
        /// </summary>
        /// <remarks>
        /// Modifying the <see cref="ProbeType"/> of the class will update the <see cref="ProbeGroup"/>
        /// so that the probe group matches the selected probe type; this will overwrite any electrode
        /// channel mappings selected.
        /// </remarks>
        [Browsable(false)]
        ...
        /// </remarks>
        [XmlIgnore]
        public NeuropixelsV2Electrode[] ChannelMap { get; }
