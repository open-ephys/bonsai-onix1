...
namespace OpenEphys.Onix1
{
    ...
    public class ConfigureNeuropixelsV2eBeta : SingleDeviceFactory, IConfigureNeuropixelsV2
    {
        ...
        /// <summary>
        /// Copy constructor for the <see cref="ConfigureNeuropixelsV2eBeta"/> class.
        /// </summary>
        /// <param name="configureNode">A pre-existing <see cref="ConfigureNeuropixelsV2eBeta"/> object.</param>
