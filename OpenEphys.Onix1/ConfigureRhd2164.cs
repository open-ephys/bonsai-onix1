    ...
    public class ConfigureRhd2164 : SingleDeviceFactory
    {
        ...
        public override IObservable<ContextTask> Process(IObservable<ContextTask> source)
        {
            ...
            return source.ConfigureAndLatchDevice(context =>
            {
                ...
                var format = device.ReadRegister(Rhd2000.FORMAT);
                ...
                var bw0 = device.ReadRegister(Rhd2000.BW0);
                var bw1 = device.ReadRegister(Rhd2000.BW1);
                var bw2 = device.ReadRegister(Rhd2000.BW2);
                var bw3 = device.ReadRegister(Rhd2000.BW3);
                var bw4 = device.ReadRegister(Rhd2000.BW4);
                var bw5 = device.ReadRegister(Rhd2000.BW5);
                ...
                device.WriteRegister(Rhd2000.BW0, bw0);
                device.WriteRegister(Rhd2000.BW1, bw1);
                device.WriteRegister(Rhd2000.BW2, bw2);
                device.WriteRegister(Rhd2000.BW3, bw3);
                device.WriteRegister(Rhd2000.BW4, bw4);
                device.WriteRegister(Rhd2000.BW5, bw5);
                device.WriteRegister(Rhd2000.FORMAT, format);
