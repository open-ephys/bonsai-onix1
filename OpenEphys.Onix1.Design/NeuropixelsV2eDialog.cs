        ...
        private void SetChannelPreset(ChannelPreset preset, NeuropixelsV2Probe probeSelected)
        {
            ...
            switch (preset)
            {
                ...
                case ChannelPreset.AllShanks0_95:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 0 && e.IntraShankIndex <= 95) ||
                ...
                case ChannelPreset.AllShanks96_191:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 96 && e.IntraShankIndex <= 191) ||
                ...
                case ChannelPreset.AllShanks192_287:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 192 && e.IntraShankIndex <= 287) ||
                ...
                case ChannelPreset.AllShanks288_383:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 288 && e.IntraShankIndex <= 383) ||
                ...
                case ChannelPreset.AllShanks384_479:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 384 && e.IntraShankIndex <= 479) ||
                ...
                case ChannelPreset.AllShanks480_575:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 480 && e.IntraShankIndex <= 575) ||
                ...
                case ChannelPreset.AllShanks576_671:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 576 && e.IntraShankIndex <= 671) ||
                ...
                case ChannelPreset.AllShanks672_767:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 672 && e.IntraShankIndex <= 767) ||
                ...
                case ChannelPreset.AllShanks768_863:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 768 && e.IntraShankIndex <= 863) ||
                ...
                case ChannelPreset.AllShanks864_959:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 864 && e.IntraShankIndex <= 959) ||
                ...
                case ChannelPreset.AllShanks960_1055:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 960 && e.IntraShankIndex <= 1055) ||
                ...
                case ChannelPreset.AllShanks1056_1151:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 1056 && e.IntraShankIndex <= 1151) ||
                ...
                case ChannelPreset.AllShanks1152_1247:
                    channelMap.SelectElectrodes(electrodes.Where(e => (e.Shank == 0 && e.IntraShankIndex >= 1152 && e.IntraShankIndex <= 1247) ||
