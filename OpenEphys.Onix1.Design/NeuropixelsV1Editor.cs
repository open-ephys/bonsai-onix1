    ...
    public class NeuropixelsV1Editor : WorkflowComponentEditor
    {
        ...
        public override bool EditComponent(ITypeDescriptorContext context, object component, IServiceProvider provider, IWin32Window owner)
        {
            if (provider != null)
            {
                ...
                if (editorState != null && !editorState.WorkflowRunning && component is IConfigureNeuropixelsV1 configureNode)
                {
                    using var editorDialog = new NeuropixelsV1Dialog(configureNode);
