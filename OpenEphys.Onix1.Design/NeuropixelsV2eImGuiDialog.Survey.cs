...
namespace OpenEphys.Onix1.Design
{
    ...
    internal partial class NeuropixelsV2eImGuiDialog
    {
        ...
        void RestoreActivityData()
        {
            ...
            var bpf = firstProbe.Annotations.GetAnnotation<bool?>("survey_bandpass_filter") ?? true;
            ...
            survey.Results = new NeuropixelsV2eSurveyResults(amp, rate, noise, thr, bpf, tpb, surveyBanks);
