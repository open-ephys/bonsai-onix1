...
namespace OpenEphys.Onix1.Design
{
    ...
    public partial class NeuropixelsV2eProbeConfigurationDialog : Form
    {
        ...
        public NeuropixelsV2eProbeConfigurationDialog(NeuropixelsV2ProbeConfiguration configuration, string calibrationFile, bool invertPolarity)
        {
            ...
            comboBoxReference.SelectedItem = ChannelConfiguration.ProbeConfiguration.Reference;
            ...
            Text += ": " + ChannelConfiguration.ProbeConfiguration.Probe.ToString();
        }
        ...
        {
            ChannelConfiguration.ProbeConfiguration = new((NeuropixelsV2eProbeGroup)ChannelConfiguration.ProbeGroup, ProbeConfiguration.Probe, ProbeConfiguration.ProbeType, ProbeConfiguration.Reference);
        ...
        void SelectedProbeTypeChanged(object sender, EventArgs e)
        {
            ...
            if (probeType != ChannelConfiguration.ProbeConfiguration.ProbeType)
            {
                ChannelConfiguration.ProbeConfiguration.ProbeType = probeType;
        ...
        {
            ChannelConfiguration.ProbeConfiguration.Reference = (NeuropixelsV2ShankReference)((ComboBox)sender).SelectedItem;
        }

        private void SelectedChannelPresetChanged(object sender, EventArgs e)
        {
            switch (ChannelConfiguration.ProbeConfiguration.ProbeType)
            {
        ...
        void SetSingleShankChannelPreset(SingleShankChannelPreset preset)
        {
            ...
            var electrodes = NeuropixelsV2eProbeGroup.ToElectrodes(ChannelConfiguration.ProbeConfiguration.ProbeGroup, NeuropixelsV2ProbeType.SingleShank);
            ...
            switch (preset)
            {
                ...
                case SingleShankChannelPreset.BankC:
                    probeConfiguration.SelectElectrodes(electrodes.Where(e => e.Bank == NeuropixelsV2Bank.D ||
                                                                             (e.Bank == NeuropixelsV2Bank.C && e.Index >= BankDStartIndex)).ToArray());
                    break;
        ...
        {
            var probeConfiguration = ChannelConfiguration.ProbeConfiguration;
            var electrodes = NeuropixelsV2eProbeGroup.ToElectrodes(ChannelConfiguration.ProbeConfiguration.ProbeGroup, NeuropixelsV2ProbeType.QuadShank);
        ...
        void CheckForExistingChannelPreset()
        {
            ...
            {
                case NeuropixelsV2ProbeType.SingleShank:
                    CheckSingleShankForChannelPreset(ChannelConfiguration.ProbeConfiguration.ChannelMap); break;
                case NeuropixelsV2ProbeType.QuadShank:
                    CheckQuadShankForChannelPreset(ChannelConfiguration.ProbeConfiguration.ChannelMap); break;
                default:
                    throw new NotSupportedException($"Unknown probe configuration found.");
            }
        }
        ...
        {
            ChannelConfiguration.ProbeConfiguration.ProbeType = NeuropixelsV2eProbeGroup.GetProbeTypeFromProbeName(ChannelConfiguration.ProbeGroup.Probes.First().Annotations.Name);
            comboBoxProbeType.SelectedItem = ChannelConfiguration.ProbeConfiguration.ProbeType;
            UpdateProbeConfiguration();
            CheckForExistingChannelPreset();
        }
        ...
        private void EnableSelectedContacts()
        {
            var selected = NeuropixelsV2eProbeGroup
                    .ToElectrodes(ChannelConfiguration.ProbeConfiguration.ProbeGroup, ChannelConfiguration.ProbeConfiguration.ProbeType)
