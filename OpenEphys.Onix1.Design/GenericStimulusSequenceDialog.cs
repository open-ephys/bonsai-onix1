...
namespace OpenEphys.Onix1.Design
{
    ...
    public partial class GenericStimulusSequenceDialog : Form
    {
        ...
        /// </summary>
        public GenericStimulusSequenceDialog(int numberOfChannels, bool useProbeGroup)
        {
            InitializeComponent();
            Shown += FormShown;
        ...
        internal void DrawStimulusWaveform()
        {
            ...
            zedGraphWaveform.GraphPane.YAxis.Scale.Min = YAxisMin;
            zedGraphWaveform.GraphPane.YAxis.Scale.Max = YAxisMax;
        ...
        private readonly double? ZoomInBoundaryY = 2;
